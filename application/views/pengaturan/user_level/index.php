...
<tr>
	<td>
		<a href="javascript:void();" onclick="ajax_link('<?php echo base_url()."pengaturan/user_level/tambah";?>')" class='btn btn-primary btn-small btn-small'>
...
<tr id='tr_<?php echo $no?>'>
	...
	<td style="text-align:center;"><a href="javascript:void();" onclick= "ajax_link('<?php echo base_url()."pengaturan/user_level/edit/".$list->id_level;?>')"><i class="icon-pencil" title="edit"></i></a>&nbsp;
